...
<li>Preencha os seguintes campos obrigatórios:<ul><li>Nome completo</li><li>E-mail</li><li>Perfil de acesso</li><li>Situação (por padrão, vem como "Ativo")</li></ul></li>
...
<li>Altere os campos desejados:<ul><li>Nome</li><li>Perfil</li><li>Situação (Ativo/Inativo)</li></ul></li>
<li>Clique em <strong>Salvar</strong></li>
</ol></Steps>
